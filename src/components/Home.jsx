  ...
  return (
    <div className='min-h-screen flex-[3] transition-all duration-500 dark:bg-black dark:text-white'>
        ...
        <a href="https://tech-bsp-2.vercel.app/">
            <button className='absolute rounded-xl top-9 left-5 p-3 text-white bg-black text-center dark:bg-white dark:text-black transition-all duration-300'>
                <FaArrowLeft size={8} /> 
            </button>
        </a>
        ...
        <main className='flex max-w-[1000px] flex-col gap-10 p-5 md:mx-10 md:py-14'>
            ...
            <div className="space-y-5">
                <h1 className='text-2xl font-bold md:text-4xl'>Professional Summary</h1>
            ...
            <div className='flex flex-col items-start justify-start gap-3'>
                <h1 className='text-2xl font-bold md:text-4xl'>Professional Skills</h1>
            ...
            <br />
            <div className='flex flex-col items-start justify-start gap-3'>
                <h1 className='text-2xl font-bold md:text-4xl'>Relevant Skills</h1>
                <div className='flex flex-wrap gap-3'>
                {[
                ...
                <div className='flex flex-col lg:flex-row lg:gap-20'>
                    <ul>
                        ...
                        <li className='relative flex flex-col gap-1 border-l p-6 before:absolute before:left-[-6px] before:top-1/2 before:h-3 before:w-3 before:-translate-y-1/2 before:rounded-full before:bg-black dark:before:bg-white before:transform'>
                            <span className='text-lg font-semibold'>Alorica</span>
                            <span className='text-sm text-gray-400'>July 2025 - Present</span>
                            <span className='font-light'>Customer Service Representative</span>
                        ...
                        {/* 2 */}
                        <li className='relative flex flex-col gap-1 border-l p-6 before:absolute before:left-[-6px] before:top-1/2 before:h-3 before:w-3 before:-translate-y-1/2 before:rounded-full before:bg-black dark:before:bg-white before:transform'>
                            <span className='text-lg font-semibold'>1Aviation Ground Handling (Cebu Pacific)</span>
                            <span className='text-sm text-gray-400'>2022 - 2025</span>
                            <span className='font-light'>Station Agent 1</span>
                            <p className='text-sm text-gray-600 dark:text-gray-400'>
                    ...
                    <ul>
                        <li className='relative flex flex-col gap-1 border-l p-6 before:absolute before:left-[-6px] before:top-1/2 before:h-3 before:w-3 before:-translate-y-1/2 before:rounded-full before:bg-black dark:before:bg-white before:transform'>
                            <span className='text-lg font-semibold'>Frontrow International</span>
                            <span className='text-sm text-gray-400'>2019 - 2022</span>
                            <span className='font-light'>Sales Associate</span>
                            <p className='text-sm text-gray-600 dark:text-gray-400'>
                        ...
                        <li className='relative flex flex-col gap-1 border-l p-6 before:absolute before:left-[-6px] before:top-1/2 before:h-3 before:w-3 before:-translate-y-1/2 before:rounded-full before:bg-black dark:before:bg-white before:transform'>
                            <span className='text-lg font-semibold'>KaFatt Kitchennete Cafe</span>
                            <span className='text-sm text-gray-400'>2016 - 2019</span>
                            <span className='font-light'>Waiter & Assistant Chef</span>
                            <p className='text-sm text-gray-600 dark:text-gray-400'>
                                Developed and maintained strong relationships with customers, providing exceptional follow-up and support to ensure satisfaction and repeat business.
                            </p>
                        </li>   
